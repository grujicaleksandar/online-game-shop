...
.no-game-found input[type=text]{
margin-right:10px;
padding:14px;
border:1px solid #47494c;
border-radius:12px;
}
.no-game-found input[type=submit]{
padding:14px 30px;
color:white;
border:1px solid #47494c;
border-radius:12px;
...
.no-game-found input[type=submit]:hover{
padding:14px 30px;
color:black;
border:1px solid #47494c;
border-radius:12px;
...
%>
<div id="container">
<div class="image-and-text clearfix">

<div class="no-game-found">

Game is not found! Search again : 
